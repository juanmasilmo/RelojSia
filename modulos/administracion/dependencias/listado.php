		...
		<div class="table-responsive">
			<table class="table table-striped table-hover table-bordered " id="dataTable" width="100%" cellspacing="0">
				...
				<tbody>
					...
					$opciones="";
					$orden=1;
					$sql="select d.id,d.id_leu, d.descripcion, l.descripcion as localidad,d.direccion, (select descripcion from dependencias where id=d.padre)as padre, (case when d.estado=1 then 'SI' else 'NO' end) AS estado from dependencias d, localidades l where d.id_localidad=l.id order by d.descripcion";
					...
					while($row=pg_fetch_array($sql))
					{
						...
						<tr <?php if($row['estado']=="NO"){?> class="bg-gray-500" <?php }?>>
							...
							<td align="left"><?php echo $row['localidad'];?></td>
							<td align="left"><?php echo $row['direccion'];?></td>
							<td align="left"><?php echo $row['padre'];?></td>
